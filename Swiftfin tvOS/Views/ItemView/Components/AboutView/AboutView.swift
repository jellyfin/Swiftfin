    ...
    struct AboutView: View {
        ...
        var body: some View {
            VStack(alignment: .leading) {
                ...
                ScrollView(.horizontal) {
                    HStack {
                        ...
                        AboutViewCard(isShowingAlert: $presentOverviewAlert,
                        ...
                        if let subtitleStreams = viewModel.playButtonItem?.subtitleStreams, !subtitleStreams.isEmpty {
                            AboutViewCard(isShowingAlert: $presentSubtitlesAlert,
                                          title: L10n.subtitles,
                                          text: subtitleStreams.compactMap { $0.displayTitle }.joined(separator: ", "))
                        }
                        
                        if let audioStreams = viewModel.playButtonItem?.audioStreams, !audioStreams.isEmpty {
                            AboutViewCard(isShowingAlert: $presentAudioAlert,
                                          title: L10n.audio,
                                          text: audioStreams.compactMap { $0.displayTitle }.joined(separator: ", "))
                        }
                    }
            ...
            .alert(L10n.subtitles, isPresented: $presentSubtitlesAlert) {
                ...
                viewModel.item.subtitleStreams.compactMap { $0.displayTitle }.joined(separator: ", ")
                    .text
            }
            .alert(L10n.audio, isPresented: $presentAudioAlert) {
                ...
                viewModel.item.audioStreams.compactMap { $0.displayTitle }.joined(separator: ", ")
                    .text
            }
        }
    }
