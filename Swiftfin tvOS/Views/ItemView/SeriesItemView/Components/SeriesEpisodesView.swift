	...
	struct SeasonsHStack: View {
		...
		var body: some View {
			ScrollView(.horizontal, showsIndicators: false) {
				...
				.focusGuide(focusGuide, tag: "seasons", onContentFocus: { focusedSeason = viewModel.selectedSeason }, top: "mediaButtons",
				            bottom: "episodes")
				.frame(height: 70)
...
extension SeriesEpisodesView {
	...
	struct EpisodesHStack: View {
		...
		var body: some View {
			...
			.focusGuide(focusGuide, tag: "episodes", onContentFocus: { focusedEpisodeIndex = lastFocusedEpisodeIndex }, top: "seasons",
			            bottom: "recommended")
