...
open class StudiosAPI {
     ...
     */
    open class func getStudio(name: String, userId: UUID? = nil, completion: @escaping ((_ data: BaseItemDto?,_ error: Error?) -> Void)) {
        getStudioWithRequestBuilder(name: name, userId: userId).execute { (response, error) -> Void in
