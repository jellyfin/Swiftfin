...
open class MoviesAPI {
    ...
    open class func getMovieRecommendations(userId: UUID? = nil, parentId: UUID? = nil, fields: [ItemFields]? = nil, categoryLimit: Int? = nil, itemLimit: Int? = nil, completion: @escaping ((_ data: [RecommendationDto]?,_ error: Error?) -> Void)) {
        getMovieRecommendationsWithRequestBuilder(userId: userId, parentId: parentId, fields: fields, categoryLimit: categoryLimit, itemLimit: itemLimit).execute { (response, error) -> Void in
  ...
  "Items" : [ {
    ...
    open class func getMovieRecommendationsWithRequestBuilder(userId: UUID? = nil, parentId: UUID? = nil, fields: [ItemFields]? = nil, categoryLimit: Int? = nil, itemLimit: Int? = nil) -> RequestBuilder<[RecommendationDto]> {
        ...
        let requestBuilder: RequestBuilder<[RecommendationDto]>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
