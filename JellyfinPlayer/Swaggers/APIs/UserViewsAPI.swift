...
open class UserViewsAPI {
    ...
    open class func getGroupingOptions(userId: UUID, completion: @escaping ((_ data: [SpecialViewOptionDto]?,_ error: Error?) -> Void)) {
        getGroupingOptionsWithRequestBuilder(userId: userId).execute { (response, error) -> Void in
  ...
  "Name" : "Name"
    ...
    open class func getGroupingOptionsWithRequestBuilder(userId: UUID) -> RequestBuilder<[SpecialViewOptionDto]> {
        ...
        let requestBuilder: RequestBuilder<[SpecialViewOptionDto]>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func getUserViews(userId: UUID, includeExternalContent: Bool? = nil, presetViews: [String]? = nil, includeHidden: Bool? = nil, completion: @escaping ((_ data: BaseItemDtoQueryResult?,_ error: Error?) -> Void)) {
        getUserViewsWithRequestBuilder(userId: userId, includeExternalContent: includeExternalContent, presetViews: presetViews, includeHidden: includeHidden).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
