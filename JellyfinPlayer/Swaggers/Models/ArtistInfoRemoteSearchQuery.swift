...
public struct ArtistInfoRemoteSearchQuery: Codable {
    ...
    public var searchInfo: AllOfArtistInfoRemoteSearchQuerySearchInfo?
    ...
    public init(searchInfo: AllOfArtistInfoRemoteSearchQuerySearchInfo? = nil, itemId: UUID? = nil, searchProviderName: String? = nil, includeDisabledProviders: Bool? = nil) {
