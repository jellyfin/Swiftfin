...
public struct SeriesTimerInfoDto: Codable {
    ...
    public var keepUntil: AllOfSeriesTimerInfoDtoKeepUntil?
    ...
    public var dayPattern: AllOfSeriesTimerInfoDtoDayPattern?
