...
public struct OpenLiveStreamDto: Codable {
    ...
    public var deviceProfile: AllOfOpenLiveStreamDtoDeviceProfile?
    /** Gets or sets the device play protocols. */
    public var directPlayProtocols: [MediaProtocol]?

    public init(openToken: String? = nil, userId: UUID? = nil, playSessionId: String? = nil, maxStreamingBitrate: Int? = nil, startTimeTicks: Int64? = nil, audioStreamIndex: Int? = nil, subtitleStreamIndex: Int? = nil, maxAudioChannels: Int? = nil, itemId: UUID? = nil, enableDirectPlay: Bool? = nil, enableDirectStream: Bool? = nil, deviceProfile: AllOfOpenLiveStreamDtoDeviceProfile? = nil, directPlayProtocols: [MediaProtocol]? = nil) {
