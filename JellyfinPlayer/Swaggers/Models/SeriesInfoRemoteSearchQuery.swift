//
// SeriesInfoRemoteSearchQuery.swift
//
...
public struct SeriesInfoRemoteSearchQuery: Codable {
    ...
    public var searchInfo: AllOfSeriesInfoRemoteSearchQuerySearchInfo?
    ...
    public init(searchInfo: AllOfSeriesInfoRemoteSearchQuerySearchInfo? = nil, itemId: UUID? = nil, searchProviderName: String? = nil, includeDisabledProviders: Bool? = nil) {
