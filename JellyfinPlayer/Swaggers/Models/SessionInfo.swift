...
public struct SessionInfo: Codable {
    ...
    public var playState: AllOfSessionInfoPlayState?
    public var additionalUsers: [SessionUserInfo]?
    public var capabilities: AllOfSessionInfoCapabilities?
    ...
    public var nowPlayingItem: AllOfSessionInfoNowPlayingItem?
    /** Class BaseItem. */
    public var fullNowPlayingItem: AllOfSessionInfoFullNowPlayingItem?
    /** This is strictly used as a data transfer object from the api layer.  This holds information about a BaseItem in a format that is convenient for the client. */
    public var nowViewingItem: AllOfSessionInfoNowViewingItem?
    /** Gets or sets the device id. */
    public var deviceId: String?
    /** Gets or sets the application version. */
    public var applicationVersion: String?
    public var transcodingInfo: AllOfSessionInfoTranscodingInfo?
