...
public struct BookInfoRemoteSearchQuery: Codable {
    ...
    public var searchInfo: AllOfBookInfoRemoteSearchQuerySearchInfo?
    ...
    public init(searchInfo: AllOfBookInfoRemoteSearchQuerySearchInfo? = nil, itemId: UUID? = nil, searchProviderName: String? = nil, includeDisabledProviders: Bool? = nil) {
