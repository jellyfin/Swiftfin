...
public struct PersonLookupInfoRemoteSearchQuery: Codable {
    ...
    public var searchInfo: AllOfPersonLookupInfoRemoteSearchQuerySearchInfo?
    ...
    public init(searchInfo: AllOfPersonLookupInfoRemoteSearchQuerySearchInfo? = nil, itemId: UUID? = nil, searchProviderName: String? = nil, includeDisabledProviders: Bool? = nil) {
