//
// AllOfTaskInfoLastExecutionResult.swift
//
...
public struct AllOfTaskInfoLastExecutionResult: Codable {
    ...
    public init(startTimeUtc: Date? = nil, endTimeUtc: Date? = nil, status: Any? = nil, name: String? = nil, key: String? = nil, _id: String? = nil, errorMessage: String? = nil, longErrorMessage: String? = nil) {
