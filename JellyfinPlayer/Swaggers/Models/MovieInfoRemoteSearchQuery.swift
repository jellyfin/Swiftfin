//
// MovieInfoRemoteSearchQuery.swift
//
...
public struct MovieInfoRemoteSearchQuery: Codable {
    ...
    public var searchInfo: AllOfMovieInfoRemoteSearchQuerySearchInfo?
    ...
    public init(searchInfo: AllOfMovieInfoRemoteSearchQuerySearchInfo? = nil, itemId: UUID? = nil, searchProviderName: String? = nil, includeDisabledProviders: Bool? = nil) {
