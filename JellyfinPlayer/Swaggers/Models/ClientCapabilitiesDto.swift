...
public struct ClientCapabilitiesDto: Codable {
    ...
    public var deviceProfile: AllOfClientCapabilitiesDtoDeviceProfile?
    /** Gets or sets the app store url. */
    public var appStoreUrl: String?
    /** Gets or sets the icon url. */
    public var iconUrl: String?

    public init(playableMediaTypes: [String]? = nil, supportedCommands: [GeneralCommandType]? = nil, supportsMediaControl: Bool? = nil, supportsContentUploading: Bool? = nil, messageCallbackUrl: String? = nil, supportsPersistentIdentifier: Bool? = nil, supportsSync: Bool? = nil, deviceProfile: AllOfClientCapabilitiesDtoDeviceProfile? = nil, appStoreUrl: String? = nil, iconUrl: String? = nil) {
