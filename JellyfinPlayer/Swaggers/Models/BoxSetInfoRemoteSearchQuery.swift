...
public struct BoxSetInfoRemoteSearchQuery: Codable {
    ...
    public var searchInfo: AllOfBoxSetInfoRemoteSearchQuerySearchInfo?
    ...
    public init(searchInfo: AllOfBoxSetInfoRemoteSearchQuerySearchInfo? = nil, itemId: UUID? = nil, searchProviderName: String? = nil, includeDisabledProviders: Bool? = nil) {
