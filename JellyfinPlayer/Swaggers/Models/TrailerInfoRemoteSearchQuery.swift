//
// TrailerInfoRemoteSearchQuery.swift
//
...
public struct TrailerInfoRemoteSearchQuery: Codable {
    ...
    public var searchInfo: AllOfTrailerInfoRemoteSearchQuerySearchInfo?
    ...
    public init(searchInfo: AllOfTrailerInfoRemoteSearchQuerySearchInfo? = nil, itemId: UUID? = nil, searchProviderName: String? = nil, includeDisabledProviders: Bool? = nil) {
