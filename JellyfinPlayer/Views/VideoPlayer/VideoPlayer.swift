...
class PlayerViewController: UIViewController, GCKDiscoveryManagerListener, GCKRemoteMediaClientListener {
	...
	@IBOutlet
	weak var upNextView: UIView!
	@IBOutlet
	weak var timeText: UILabel!
	@IBOutlet
	weak var timeLeftText: UILabel!
	@IBOutlet
	weak var videoContentView: UIView!
	@IBOutlet
	weak var videoControlsView: UIView!
	@IBOutlet
	weak var seekSlider: UISlider!
	@IBOutlet
	weak var titleLabel: UILabel!
	@IBOutlet
	weak var jumpBackButton: UIButton!
	@IBOutlet
	weak var jumpForwardButton: UIButton!
	@IBOutlet
	weak var playerSettingsButton: UIButton!
	@IBOutlet
	weak var castButton: UIButton!
	...
	@IBAction
	func seekSliderStart(_ sender: Any) {
	...
	@IBAction
	func seekSliderValueChanged(_ sender: Any) {
	...
	@IBAction
	func seekSliderEnd(_ sender: Any) {
		isSeeking = false
	...
	@IBAction
	func controlViewTapped(_ sender: Any) {
		if playerDestination == .local {
	...
	@IBAction
	func contentViewTapped(_ sender: Any) {
		if playerDestination == .local {
	...
	@IBAction
	func jumpBackTapped(_ sender: Any) {
		if paused == false {
			if playerDestination == .local {
	...
	@IBAction
	func jumpForwardTapped(_ sender: Any) {
		if paused == false {
			if playerDestination == .local {
	...
	@IBOutlet
	weak var mainActionButton: UIButton!
	@IBAction
	func mainActionButtonPressed(_ sender: Any) {
		if paused {
			if playerDestination == .local {
				mediaPlayer.play()
	...
	@IBAction
	func castButtonPressed(_ sender: Any) {
...
struct VLCPlayerWithControls: UIViewControllerRepresentable {
	var item: BaseItemDto
	@RouterObject
	var playerRouter: VideoPlayerCoordinator.Router?
