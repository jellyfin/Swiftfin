...
private struct ItemView: View {
	...
	@State
	private var videoIsLoading: Bool = false // This variable is only changed by the underlying VLC view.
	@State
	private var viewDidLoad: Bool = false
	@State
	private var orientation: UIDeviceOrientation = .unknown
	@StateObject
	private var videoPlayerItem = VideoPlayerItem()
