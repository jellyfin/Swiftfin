...
final class PlaybackManager {
    ...
    func sendStartReport(_ request: ReportPlaybackStartRequest,
    ...
    func sendProgressReport(_ request: ReportPlaybackProgressRequest,
                            onSuccess: @escaping () -> Void,
                            onFailure: @escaping (Error) -> Void) {
    ...
    func sendStopReport(_ request: ReportPlaybackStoppedRequest,
                        onSuccess: @escaping () -> Void,
                        onFailure: @escaping (Error) -> Void) {
