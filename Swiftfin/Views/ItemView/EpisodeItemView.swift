...
struct EpisodeItemView: View {
    ...
    var body: some View {
        GeometryReader { geometry in
            NavBarOffsetScrollView(headerHeight: UIDevice.isPortrait ? geometry.size.width / 2 : 10) {
                VStack {
                    ...
                    VStack(spacing: 10) {
                        ...
                        HStack {
                            ListDetailsView(title: "Information", items: [
                                .init(title: "Premiered", content: viewModel.item.premiereDateFormatted ?? "--"),
                                .init(title: "Rated", content: viewModel.item.officialRating ?? "--"),
                                .init(title: "Runtime", content: viewModel.item.getItemRuntime() ?? "--")
                            ])
