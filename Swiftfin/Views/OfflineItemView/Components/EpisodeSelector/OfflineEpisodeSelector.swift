...
struct OfflineSeriesEpisodeSelector: View {
    ...
    @State
    private var selection: OfflineSeasonItemViewModel?
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            Group {
                if let selection {
                    EpisodeHStack(viewModel: selection, offlineViewModel: offlineViewModel, playButtonItem: viewModel.playButtonItem)
                } else {
                    LoadingHStack()
                }
            }
