...
extension OfflineItemView {
    ...
    struct CinematicScrollView<Content: View>: View {
        ...
        private var headerView: some View {
            ImageView(viewModel.download!.cinematicImageSources(maxWidth: UIScreen.main.bounds.width))
        ...
        var body: some View {
            OffsetScrollView(headerHeight: 0.75) {
                ...
                VStack {
                    ...
                    OverlayView(viewModel: viewModel, offlineViewModel: offlineViewModel)
...
extension OfflineItemView.CinematicScrollView {
