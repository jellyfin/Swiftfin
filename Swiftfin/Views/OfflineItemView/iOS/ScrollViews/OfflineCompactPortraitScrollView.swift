...
extension OfflineItemView {
    ...
    struct CompactPosterScrollView<Content: View>: View {
        ...
        private var headerView: some View {
            ImageView(viewModel.download!.cinematicImageSources())
        ...
        var body: some View {
            OffsetScrollView(headerHeight: 0.45) {
                ...
                VStack {
                    ...
                    OverlayView(offlineViewModel: offlineViewModel, viewModel: viewModel)
...
extension OfflineItemView.CompactPosterScrollView {
        ...
        var body: some View {
            VStack(alignment: .leading, spacing: 10) {
                HStack(alignment: .bottom, spacing: 12) {
                    ...
                    ImageView(viewModel.item.portraitImageSources(maxWidth: 130))
                        .failure {
                ...
                HStack(alignment: .center) {
                    ...
                    OfflineItemView.ActionButtonHStack(viewModel: viewModel, equalSpacing: false)
                        .font(.title2)
                        .foregroundColor(.white)
                }
            }
