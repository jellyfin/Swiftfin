...
struct PagingCollectionView: UIViewRepresentable {
    ...
    class Coordinator: NSObject, UICollectionViewDelegate {
        ...
        func configureDataSource() {
            let cellRegistration = UICollectionView.CellRegistration<HostingCollectionViewCell, BaseItemDto> { cell, _, item in
        ...
        func scrollViewDidScroll(_ scrollView: UIScrollView) {
            ...
            let adjustedHeight = scrollView.contentSize.height - scrollView.frame.height + scrollView.adjustedContentInset
                .bottom - bottomOffset
