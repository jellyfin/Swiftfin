...
| [Dolby Vision Profile 7](https://en.wikipedia.org/wiki/Dolby_Vision#Profiles)                  | ❌                | 🔶 [1]            |
...
- [3] Requires an AV1 compatible device (Apple A16 Bionic or M3 and above) or a custom profile with AV1 enabled.
