...
class InfoTabBarViewController: UITabBarController, UIGestureRecognizerDelegate {
	...
	func setupInfoViews(mediaItem: BaseItemDto, subtitleTracks: [Subtitle], selectedSubtitleTrack: Int32, audioTracks: [AudioTrack],
	                    selectedAudioTrack: Int32, delegate: VideoPlayerSettingsDelegate)
	{
		...
		subtitleViewController?.prepareSubtitleView(subtitleTracks: subtitleTracks, selectedTrack: selectedSubtitleTrack,
		                                            delegate: delegate)
	}
