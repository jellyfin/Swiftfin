...
internal enum L10n {
  ...
  /// Provided a custom jump interval in seconds.
  internal static let customJumpIntervalDescription = L10n.tr("Localizable", "customJumpIntervalDescription", fallback: "Provided a custom jump interval in seconds.")
  /// Custom name
