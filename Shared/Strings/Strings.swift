...
internal enum L10n {
  ...
  /// Invalidated Login
  internal static let invalidatedLogin = L10n.tr("Localizable", "invalidatedLogin", fallback: "The login for this user has been invalidated by the server. Please retry or re-authenticate.")
  /// Inverted Dark
