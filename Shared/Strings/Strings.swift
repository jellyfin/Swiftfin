...
internal enum L10n {
  ...
  /// Edit %@
  internal static func editWithItem(_ p1: Any) -> String {
    return L10n.tr("Localizable", "editWithItem", String(describing: p1), fallback: "Edit %@")
  }
  /// Empty Next Up
  ...
  /// File Path
  internal static let filePath = L10n.tr("Localizable", "filePath", fallback: "File Path")
  /// Filter Results
  ...
  /// Item
  internal static let item = L10n.tr("Localizable", "item", fallback: "Item")
  /// %1$@ at %2$@
  ...
  /// Manage your metadata to organize and enrich your Jellyfin library’s information.
  internal static let metadataDescription = L10n.tr("Localizable", "metadataDescription", fallback: "Manage your metadata to organize and enrich your Jellyfin library’s information.")
  ...
  /// New %@
  internal static func newWithItem(_ p1: Any) -> String {
    return L10n.tr("Localizable", "newWithItem", String(describing: p1), fallback: "New %@")
  }
  /// Next
