...
final class SettingsCoordinator: NavigationCoordinatable {
    ...
    func makeAbout() -> some View {
        ...
        func makeFontPicker(onFontPick: @escaping (UIFontDescriptor) -> Void) -> NavigationViewCoordinator<FontPickerCoordinator> {
            NavigationViewCoordinator(FontPickerCoordinator(onFontPick: onFontPick))
        }
    #endif
